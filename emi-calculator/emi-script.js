...
function resetHypotheticalComparison(){const card=$('hypothetical-impact-card'); card.classList.add('hidden'); card.classList.remove('scenario-flash'); setText('hypothetical-highlight','Try a hypothetical prepayment to compare it against your current actual plan.'); setText('hypothetical-amount',formatCurrency(0)); setText('hypothetical-date',''); setText('scenario-current-emi',formatCurrency(0)); setText('scenario-current-interest',formatCurrency(0)); setText('scenario-current-tenure','0m'); setText('scenario-hypothetical-emi',formatCurrency(0)); setText('scenario-hypothetical-interest',formatCurrency(0)); setText('scenario-hypothetical-tenure','0m');}
function renderHypotheticalComparison(baseLoan,impact){const card=$('hypothetical-impact-card'); const resultingLoan=impact?.resultingLoan; if(!baseLoan||!impact||!resultingLoan){resetHypotheticalComparison(); return;} card.classList.remove('hidden'); card.classList.remove('scenario-flash'); void card.offsetWidth; card.classList.add('scenario-flash'); setText('hypothetical-highlight',`You save ${formatCurrency(impact.interestSaved)} and ${fmtTenure(impact.monthsReduced)} with this simulation.`); setText('hypothetical-amount',formatCurrency(impact.amount)); setText('hypothetical-date',formatDate(impact.date)); setText('scenario-current-emi',formatCurrency(baseLoan.emi)); setText('scenario-current-interest',formatCurrency(baseLoan.totalInterest)); setText('scenario-current-tenure',fmtTenure(baseLoan.totalMonths)); setText('scenario-hypothetical-emi',formatCurrency(resultingLoan.emi)); setText('scenario-hypothetical-interest',formatCurrency(resultingLoan.totalInterest)); setText('scenario-hypothetical-tenure',fmtTenure(resultingLoan.totalMonths));}
